...
class Person
{
	...
	function __toString()
	{
		return "$this->firstName $this->lastName is $this->age and weighs $this->weight lbs<br>";
	}
...
$pugilist2 = new Pugilist('Konan', 'The Barbarian', 30, 250);

$winner = $pugilist1->fight($pugilist2);

echo "The winner is ", $winner->firstName, ' ', $winner->lastName;